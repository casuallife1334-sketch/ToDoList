...
func (s *HTTPServer) StartServer() error {
	...
	router.Path("/tasks/{id}").Methods("GET").HandlerFunc(s.httpHandlers.HandleGetTask)
	...
	router.Path("/tasks/{id}").Methods("PATCH").HandlerFunc(s.httpHandlers.HandleUpdateTask)
	router.Path("/tasks/{id}").Methods("DELETE").HandlerFunc(s.httpHandlers.HandleDeleteTask)
